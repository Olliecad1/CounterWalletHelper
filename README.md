...
7. Now to retrieve a list of your addresses and their private keys USE YOUR OWN PRIVATE PASS PHRASE (The pass phrase used below is just an example).
...
9. But if you want to retrieve your private keys then run these commands
